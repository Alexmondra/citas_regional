...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="<?php echo BASE_URL;?>views/dashboard/plugins/fontawesome-free/css/all.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo BASE_URL;?>views/dashboard/dist/css/adminlte.min.css">
</head>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?controller=User" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>usuarios</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?controller=paciente" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>pacientes</p>
                </a>
              </li>
...
<!-- jQuery -->
<script src="<?php echo BASE_URL;?>views/dashboard/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
